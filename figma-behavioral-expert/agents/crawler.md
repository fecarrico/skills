...
Uma "Tela" para auditoria de heurísticas é qualquer nó do tipo `FRAME`, `COMPONENT` ou `INSTANCE` que atenda aos critérios de dimensão (geralmente `height > 100`).
...
Apresente o checklist e peça confirmação. **Destaque o escopo detectado.**
...
**PARE AQUI**. Somente avance para a captura de imagens ou análise (FASE 2) **APÓS a aprovação explícita do usuário**.
